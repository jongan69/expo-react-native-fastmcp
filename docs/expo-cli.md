...
| ~~`EXPO_NO_INSPECTOR_PROXY`~~ | boolean | Deprecated Disable the customized inspector proxy with improved support for the Chrome DevTools protocol. This includes support for the network inspector. |
...
| `EXPO_METRO_UNSTABLE_ERRORS` | boolean | Experimental Enable unstable error message improvements in Metro bundler. The features behind this flag are subject to removal and may be upstreamed. |
