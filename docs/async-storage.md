@react-native-async-storage/async-storage - Expo Documentation
...
[GitHub](https://github.com/react-native-async-storage/async-storage)[npm](https://www.npmjs.com/package/@react-native-async-storage/async-storage)
...
`-Â``npx expo install @react-native-async-storage/async-storage`
...
Get full information on API and its usage.](https://react-native-async-storage.github.io/async-storage/docs/usage)

[Previous (Third-party libraries)

Overview](/versions/v53.0.0/sdk/third-party-overview)[Next (Third-party libraries)

@react-native-community/datetimepicker](/versions/v53.0.0/sdk/date-time-picker)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @react-native-async-storage/async-storage](https://chat.expo.dev/)
* [View open bug reports for @react-native-async-storage/async-storage](https://github.com/react-native-async-storage/async-storage/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/async-storage.mdx)
...
[Installation](/versions/v53.0.0/sdk/async-storage/#installation)[Learn more](/versions/v53.0.0/sdk/async-storage/#learn-more)