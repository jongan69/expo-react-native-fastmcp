Third-party libraries supported in Expo Go - Expo Documentation
...
[Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/third-party-overview.mdx)
...
Learn how to use other third-party npm libraries in your project.](/workflow/using-libraries#third-party-libraries)
[Introduction to development builds

Learn why use development builds, and how to get started.](/develop/development-builds/introduction)

[Previous (Expo SDK)

WebBrowser](/versions/v53.0.0/sdk/webbrowser)[Next (Third-party libraries)

@react-native-async-storage/async-storage](/versions/v53.0.0/sdk/async-storage)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about Third-party libraries supported in Expo Go](https://chat.expo.dev/)
* [View open bug reports for Third-party libraries supported in Expo Go](https://github.com/expo/expo/labels/Third-party libraries supported in Expo Go)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/third-party-overview.mdx)
