@shopify/flash-list - Expo Documentation
...
[GitHub](https://github.com/shopify/flash-list)[npm](https://www.npmjs.com/package/@shopify/flash-list)
...
`-Â``npx expo install @shopify/flash-list`
...
Get full information on API and its usage.](https://shopify.github.io/flash-list/)

[Previous (Third-party libraries)

@react-native-segmented-control/segmented-control](/versions/v53.0.0/sdk/segmented-control)[Next (Third-party libraries)

@shopify/react-native-skia](/versions/v53.0.0/sdk/skia)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @shopify/flash-list](https://chat.expo.dev/)
* [View open bug reports for @shopify/flash-list](https://github.com/shopify/flash-list/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/flash-list.mdx)
...
[Installation](/versions/v53.0.0/sdk/flash-list/#installation)[Learn more](/versions/v53.0.0/sdk/flash-list/#learn-more)