react-native-pager-view - Expo Documentation
...
`-Â``npx expo install react-native-pager-view`
...
Get full information on API and its usage.](https://github.com/callstack/react-native-pager-view)

[Previous (Third-party libraries)

react-native-maps](/versions/v53.0.0/sdk/map-view)[Next (Third-party libraries)

react-native-reanimated](/versions/v53.0.0/sdk/reanimated)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about react-native-pager-view](https://chat.expo.dev/)
* [View open bug reports for react-native-pager-view](https://github.com/callstack/react-native-pager-view/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/view-pager.mdx)
...
[Installation](/versions/v53.0.0/sdk/view-pager/#installation)[Example](/versions/v53.0.0/sdk/view-pager/#example)[Learn more](/versions/v53.0.0/sdk/view-pager/#learn-more)