react-native-gesture-handler - Expo Documentation
...
[GitHub](https://github.com/software-mansion/react-native-gesture-handler)[npm](https://www.npmjs.com/package/react-native-gesture-handler)
...
`-Â``npx expo install react-native-gesture-handler`
...
Get full information on API and its usage.](https://docs.swmansion.com/react-native-gesture-handler/)

[Previous (Third-party libraries)

lottie-react-native](/versions/v53.0.0/sdk/lottie)[Next (Third-party libraries)

react-native-maps](/versions/v53.0.0/sdk/map-view)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about react-native-gesture-handler](https://chat.expo.dev/)
* [View open bug reports for react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/gesture-handler.mdx)
...
[Installation](/versions/v53.0.0/sdk/gesture-handler/#installation)[Learn more](/versions/v53.0.0/sdk/gesture-handler/#learn-more)