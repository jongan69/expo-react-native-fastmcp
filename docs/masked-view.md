@react-native-masked-view/masked-view - Expo Documentation
...
[GitHub](https://github.com/react-native-masked-view/masked-view)[npm](https://www.npmjs.com/package/@react-native-masked-view/masked-view)
...
`-Â``npx expo install @react-native-masked-view/masked-view`
...
Get full information on API and its usage.](https://github.com/react-native-masked-view/masked-view)

[Previous (Third-party libraries)

@react-native-community/slider](/versions/v53.0.0/sdk/slider)[Next (Third-party libraries)

@react-native-picker/picker](/versions/v53.0.0/sdk/picker)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @react-native-masked-view/masked-view](https://chat.expo.dev/)
* [View open bug reports for @react-native-masked-view/masked-view](https://github.com/react-native-masked-view/masked-view/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/masked-view.mdx)
...
[Installation](/versions/v53.0.0/sdk/masked-view/#installation)[Learn more](/versions/v53.0.0/sdk/masked-view/#learn-more)