react-native-screens - Expo Documentation
...
`-Â``npx expo install react-native-screens`
...
Get full information on API and its usage.](https://docs.swmansion.com/react-native-screens/)

[Previous (Third-party libraries)

react-native-safe-area-context](/versions/v53.0.0/sdk/safe-area-context)[Next (Third-party libraries)

react-native-svg](/versions/v53.0.0/sdk/svg)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about react-native-screens](https://chat.expo.dev/)
* [View open bug reports for react-native-screens](https://github.com/software-mansion/react-native-screens/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/screens.mdx)
...
[Installation](/versions/v53.0.0/sdk/screens/#installation)[Learn more](/versions/v53.0.0/sdk/screens/#learn-more)