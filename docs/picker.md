...
[GitHub](https://github.com/react-native-picker/picker)[npm](https://www.npmjs.com/package/@react-native-picker/picker)
...
`-Â``npx expo install @react-native-picker/picker`
...
Get full information on API and its usage.](https://github.com/react-native-picker/picker)

[Previous (Third-party libraries)

@react-native-masked-view/masked-view](/versions/v53.0.0/sdk/masked-view)[Next (Third-party libraries)

@react-native-segmented-control/segmented-control](/versions/v53.0.0/sdk/segmented-control)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @react-native-picker/picker](https://chat.expo.dev/)
* [View open bug reports for @react-native-picker/picker](https://github.com/react-native-picker/picker/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/picker.mdx)
...
[Installation](/versions/v53.0.0/sdk/picker/#installation)[Learn more](/versions/v53.0.0/sdk/picker/#learn-more)