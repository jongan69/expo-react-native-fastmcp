@react-native-segmented-control/segmented-control - Expo Documentation
...
[GitHub](https://github.com/react-native-community/segmented-control)[npm](https://www.npmjs.com/package/@react-native-segmented-control/segmented-control)
...
`-Â``npx expo install @react-native-segmented-control/segmented-control`
...
Get full information on API and its usage.](https://github.com/react-native-community/segmented-control)

[Previous (Third-party libraries)

@react-native-picker/picker](/versions/v53.0.0/sdk/picker)[Next (Third-party libraries)

@shopify/flash-list](/versions/v53.0.0/sdk/flash-list)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @react-native-segmented-control/segmented-control](https://chat.expo.dev/)
* [View open bug reports for @react-native-segmented-control/segmented-control](https://github.com/react-native-community/segmented-control/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/segmented-control.mdx)
...
[Installation](/versions/v53.0.0/sdk/segmented-control/#installation)[Learn more](/versions/v53.0.0/sdk/segmented-control/#learn-more)