...
Right-to-Left Layout Support For React Native Apps](/blog/2016/08/19/right-to-left-support-for-react-native-apps)[Older post

Toward Better Documentation](/blog/2016/07/06/toward-better-documentation)

* [Rapid Prototyping in React at Zynga](#rapid-prototyping-in-react-at-zynga)* [Designing APIs for React Native at Netflix](#designing-apis-for-react-native-at-netflix)* [Bridging the Gap, Using React Native in Existing Codebases](#bridging-the-gap-using-react-native-in-existing-codebases)
      + [The Navigation Problem](#the-navigation-problem)* [Closing Remarks](#closing-remarks)
