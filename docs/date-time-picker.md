@react-native-community/datetimepicker - Expo Documentation
...
[GitHub](https://github.com/react-native-community/react-native-datetimepicker)[npm](https://www.npmjs.com/package/@react-native-community/datetimepicker)
...
`-Â``npx expo install @react-native-community/datetimepicker`
...
Get full information on API and its usage.](https://github.com/react-native-datetimepicker/datetimepicker)

[Previous (Third-party libraries)

@react-native-async-storage/async-storage](/versions/v53.0.0/sdk/async-storage)[Next (Third-party libraries)

@react-native-community/netinfo](/versions/v53.0.0/sdk/netinfo)

Was this doc helpful?

* Share your feedback
* [Ask a question on the forums about @react-native-community/datetimepicker](https://chat.expo.dev/)
* [View open bug reports for @react-native-community/datetimepicker](https://github.com/react-native-community/react-native-datetimepicker/issues)
* [Edit this page](https://github.com/expo/expo/edit/main/docs/pages/versions/v53.0.0/sdk/date-time-picker.mdx)
...
[Installation](/versions/v53.0.0/sdk/date-time-picker/#installation)[Learn more](/versions/v53.0.0/sdk/date-time-picker/#learn-more)