React Native for Android: How we built the first cross-platform React Native app · React Native
...
Making React Native apps accessible](/blog/2015/11/23/making-react-native-apps-accessible)[Older post
