...
![](/assets/images/0.76-bridge-diagram-a653d794d04871e5b7a026e35d8edf03.png)
...
![](/assets/images/0.76-directory-85387cf0da638f887bbf996c39db432d.png)
...
React Native 0.77 - New Styling Features, Android’s 16KB page support, Swift Template](/blog/2025/01/21/version-0.77)[Older post
...
* [What is the New Architecture](#what-is-the-new-architecture)
  + [New Native Modules](#new-native-modules)+ [New Renderer](#new-renderer)+ [The Event Loop](#the-event-loop)+ [Removing the Bridge](#removing-the-bridge)+ [Gradual Migration](#gradual-migration)* [New Features](#new-features)
    + [Transitions](#transitions)+ [Automatic Batching](#automatic-batching)+ [useLayoutEffect](#uselayouteffect)+ [Full Support for Suspense](#full-support-for-suspense)* [How to Upgrade](#how-to-upgrade)
      + [Apps](#apps)+ [Libraries](#libraries)+ [Opt-out](#opt-out)* [Thanks](#thanks)
